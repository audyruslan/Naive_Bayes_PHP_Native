                    ...
                    <div class="col">
                        ...
                        <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="kondisi/tambah.php" method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="nama_kriteria">Pilih Kriteria</label>
                                                <select class="form-control" name="nama_kriteria" id="nama_kriteria">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" autocomplete="off" class="form-control" id="kondisi" name="kondisi" placeholder="Masukkan Kondisi">
                                            </div>
                                        </div>
                        ...
                        <div class="col-12">
                            <table class="table table-bordered table-hover" id="example" cellspacing="0">
                                ...
                                <?php
                                $i = 1;
                                $sql = mysqli_query($conn, "SELECT * FROM tb_kondisi");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm hapus_kondisi" href="kondisi/hapus.php?id=<?= $row["id"]; ?>"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="EditModal<?= $row["id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="#EditModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="EditModalLabel">Ubah Kondisi</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <form action="kondisi/ubah.php" method="post">
                                                    <div class="modal-body">
                                                        <input type="hidden" name="id" value="<?= $row["id"]; ?>">
                                                        <div class="form-group">
                                                            <label for="nama_kriteria">Kriteria yang Dipilih</label>
                                                            <select class="form-control" name="nama_kriteria" id="nama_kriteria">
                                                                <option>--Silahkan Pilih--</option>
                                                                <?php
                                                                $query = mysqli_query($conn, "SELECT * FROM tb_kriteria");
                                                                while ($kriteria = mysqli_fetch_array($query)) {
                                                                ?>
                                                                    <option value="<?= $kriteria[1]; ?>" <?php if ($row["nama_kriteria"] == $kriteria[1]) echo 'selected="selected"'; ?>><?= $kriteria[1]; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="kondisi">Kondisi</label>
                                                            <input type="text" autocomplete="off" class="form-control" id="kondisi" name="kondisi" value="<?= $row["kondisi"]; ?>" placeholder="Nama Kondisi">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
